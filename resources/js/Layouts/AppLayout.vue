    ...
    <div>
        ...
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <jet-nav-link :href="route('users.list')" :active="route().current('users.list')">
                                    Users
                                </jet-nav-link>
                                <jet-nav-link :href="route('news.list')" :active="route().current('news.list')">
                                    News
                                </jet-nav-link>
                            </div>
                        </div>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <jet-responsive-nav-link :href="route('users.list')" :active="route().current('users.list')">
                            Users
                        </jet-responsive-nav-link>
                        <jet-responsive-nav-link :href="route('news.list')" :active="route().current('news.list')">
                            News
                        </jet-responsive-nav-link>
                    </div>
            ...
            <div v-if="$page.props.flash.message">
                <div id="alert" class="alert" v-bind:class="'alert-'+$page.props.flash.type" role="alert" >
                    <strong>{{ $page.props.flash.title }}</strong> {{ $page.props.flash.message }}
                </div>
            </div>
